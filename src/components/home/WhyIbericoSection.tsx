  ...
  return (
    <section id="whyIberico" ref={sectionRef} className="opacity-0 relative">
      <div className="grid grid-cols-1 md:grid-cols-3 h-screen min-h-[600px]">
        <div className="relative h-full opacity-0 animate-slideInLeft hidden md:block" style={{ animationDelay: '0.2s' }}>
          <img 
        ...
        <div className="relative h-full opacity-0 animate-slideUp hidden md:block" style={{ animationDelay: '0.4s' }}>
          <img 
        ...
        <div className="relative h-full opacity-0 animate-slideInRight hidden md:block" style={{ animationDelay: '0.2s' }}>
          <img 
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10 text-center px-4">
        <h2 className="font-poppins text-4xl md:text-6xl text-white font-light mb-4 opacity-0 animate-scaleUp" style={{ animationDelay: '0.6s' }}>
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-8">
          <p className="text-base md:text-lg text-white font-roboto leading-relaxed font-light mb-8 opacity-0 animate-slideUp" style={{ animationDelay: '1s' }}>
            {t('sections.whyIberico.content1')}
          </p>
          
          <p className="text-base md:text-lg text-white font-roboto leading-relaxed font-light opacity-0 animate-slideUp" style={{ animationDelay: '1.2s' }}>
