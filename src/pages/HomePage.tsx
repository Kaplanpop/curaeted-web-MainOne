...
const HomePage = () => {
  ...
  return <div className="min-h-screen pt-20">
      ...
      <section id="contact" ref={contactRef} className="relative opacity-0 overflow-hidden">
        {/* White curved section - moved to top */}
        <div className="bg-white pt-32 pb-20 px-4 md:px-8 lg:px-16 relative z-10">
          <h2 className="font-poppins text-6xl mb-4 text-black font-light text-center">
            Contact
          </h2>
          
          <p className="text-xl text-gray-800 font-roboto font-light text-center mb-10 mx-auto max-w-5xl">
